...
<html>
	<head>
		...
		<link rel="stylesheet" href="/rc/Public/css/search.css">
	...
	<body>
		...
		<script type="text/javascript">
			var eles = document.getElementsByClassName('comment_' + '<?php echo $searchType ?>');
			for (var i = 0; i < eles.length; ++i) {
				eles[i].style.color = 'red';
			}
		</script>
		<script type="text/javascript" src="/rc/Public/js/jquery-2.1.4.min.js"></script>
		<script type="text/javascript" src="/rc/Public/js/bootstrap.min.js"></script>
		...
		<script type="text/javascript" src="/rc/Public/js/search.js"></script>
